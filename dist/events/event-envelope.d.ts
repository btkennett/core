 ...
 */
export type CompassEventType = "order.created" | "order.status_changed" | "hold.created" | "hold.released" | "hold.expired" | "plan.created" | "rate_exception.requested" | "rate_exception.approved" | "rate_exception.denied";
/**
 * Forge event types emitted by fn-forge
 *
 * These flow from Forge → Flux via POST to /api/integrations/forge-events
 */
export type ForgeEventType = "submission.approved" | "submission.rejected" | "submission.revision_requested" | "submission.escalated";
/**
...
export type FnEventType = CompassEventType | ForgeEventType | FulfillmentEventType | CompassSyncEventType;
