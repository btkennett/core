...
export const INTEGRATION_RETRY = {
    maxAttempts: 5,
    factor: 2,
...
export const CLASSIFICATION_RETRY = {
    maxAttempts: 2,
    factor: 2,
    minTimeoutInMs: 2_000,
...
export function calculateRetryDelay(preset, attempt) {
    const delay = Math.min(preset.minTimeoutInMs * Math.pow(preset.factor, attempt), preset.maxTimeoutInMs);
    if (preset.randomize) {
...
//# sourceMappingURL=retry-presets.js.map